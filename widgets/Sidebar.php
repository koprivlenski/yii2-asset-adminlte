...
namespace koprivlenski\widgets;
...
/**
 * Sidebar renders a nav HTML component.
 * It is derived from the Nav one from yii/bootstrap
 *
 * For example:
 *
 * ```php
    ...
    public function renderItem($item)
    {
        ...
        if ($items !== null) {
            ...
            if (is_array($items)) {
                ...
                $items = $this->renderDropdown($items, $item, $options);
            }
        }
